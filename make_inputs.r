library(gdata)
source('~/rscripts/scope_wrappers/fun/make_setoptions.r')
source('~/rscripts/scope_wrappers/fun/make_inputdata.r')
...
N15 = 1 	 #verify		              verifiy the results (compare to saved 'standard' output) to test the code for the first time?
...
startDOY = 169.0		# Julian day (decimal) of start of simulations
